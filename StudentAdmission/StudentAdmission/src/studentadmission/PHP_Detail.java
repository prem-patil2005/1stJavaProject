...
public class PHP_Detail {
    ...
    String n;
    int fee = 200000;
    String du = "3 Years",courseName = "PHP";
  

    public PHP_Detail(Scanner s1) {
        this.s1 = s1;
        ...
        public void showDetail(Scanner s1){
            ...
            System.out.println("Name of The Course : Bachelor of Computer Application.");
            System.out.println("Duration : 3 Years.");
            System.out.println("Fees : 2 Lakh.");
